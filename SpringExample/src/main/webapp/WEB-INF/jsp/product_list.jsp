...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resources'/>/css/plist20131112.css" media="all">
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resources'/>/css/list-page-20141009.css" media="all">
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resources'/>/css/pop_compare.css" media="all">
<link rel="shortcut icon" type="image/ico"
	href="http://list.jd.com/favicon.ico">
<%-- <script type="text/javascript" src="<c:url value='/resources'/>/common/js/jquery-1.2.6.pack.js"></script> --%>
<script type="text/javascript" src="<c:url value='/resources'/>/common/js/jquery-3.1.1.min.js"></script>
...
<div id="shortcut-2013">
	<div class="w">
		<ul class="fl lh">
			<li class="fore1 ld"><b></b><a href="#" rel="nofollow">收藏卡卡西</a></li>
		</ul>
		<ul class="fr lh">
			<li class="fore1" id="loginbar">您好，欢迎来到卡卡西！<span><a href="#">[登录]</a> <a href="#" class="link-regist">[免费注册]</a></span></li>
			<li class="fore2 ld">
				<s></s>
			...
			<li class="fore3 ld menu" id="app-jd" data-widget="dropdown" clstag="homepage|keycount|home2013|01d"><s></s>
				...
				<a href="http://app.jd.com/" target="_blank">手机卡卡西</a>
				<b></b>
			</li>
...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="http://www.jd.com/" hidefocus="true"><b></b><img src="<c:url value='/resources'/>/images/kakaxi.png" width="270" height="60" alt="卡卡西"></a></div>
		<!--logo end-->
		<div id="search-2013">
			<div class="i-search ld">
				<ul id="shelper" class="hide"></ul>
				<form id="actionForm" action="${ pageContext.request.contextPath}/solrJD/list" method="POST">
				<div class="form">
		...
		<div id="my360buy-2013">
			<dl>
				<dt class="ld"><s></s><a href="http://home.jd.com/">我的卡卡西</a><b></b></dt>
				<dd>
...
<div id="filter">
	...
	<div class="fore1">
		...
		<div class="pagin pagin-m">
			<span class="text"><i>${list.curPage }</i>/${list.pageCount }</span>
			<c:if test="${ list.curPage != 1 }">
				<a href="javascript:changePage(-1)" class="prev">上一页<b></b></a>
			</c:if>
			<c:if test="${ list.curPage != list.pageCount }">
				<a href="javascript:changePage(1)" class="next">下一页<b></b></a>
			</c:if>
		</div>
		<div class="total">
			<span>共<strong>${ list.recordCount }</strong>个商品
			</span>
		</div>
		<span class="clr"></span>
	</div>
			...
			<div class="lh-wrap">
				<div class="p-img">
					<a target="_blank" href="#">
						<img width="220" height="220" class="err-product" src="<c:url value='/resources/images/plp'/>/${item.product_picture}">
					</a>
				</div>
				<div class="p-name">
					<a target="_blank" href="#">${item.product_name}</a>
				</div>
				<div class="p-price">
					<strong>￥${item.product_price }</strong><span id="p1269191543"></span>
				</div>
			</div>
		</li>
		</c:forEach>
    ...
    <div id="service-2013">
        ...
        <dl class="fore5">
            ...
            <dd>
                ...
                <div><a href="http://giftcard.jd.com/market/index.action" target="_blank" rel="nofollow">卡卡西E卡</a></div>
                <div><a href="http://help.jd.com/help/question-91.html" target="_blank" rel="nofollow">节能补贴</a></div>
                <div><a href="http://mobile.jd.com/" target="_blank" rel="nofollow">卡卡西通信</a></div>
            </dd>
        </dl>
        <span class="clr"></span>
    </div>
    ...
    <div id="footer-2013">
        ...
        <div class="authentication"><a rel="nofollow" target="_blank" href="http://www.hd315.gov.cn/beian/view.asp?bianhao=010202007080200026"><img width="108" height="40" alt="经营性网站备案中心" src="<c:url value='/resources'/>/images/108_40_zZOKnl.gif" class="err-product"></a>
            <a rel="nofollow" target="_blank" tabindex="-1"
				...
				src="<c:url value='/resources'/>/images/rBEHaFCFC5QIAAAAAAASVQX9RAYAACb2wHUV1kAABJt760.gif"
				class="err-product"></a>
			<a rel="nofollow" target="_blank"
				href="http://www.bj.cyberpolice.cn/index.do"><img width="108"
				height="40" alt="朝阳网络警察"
				src="<c:url value='/resources'/>/images/rBEIDE_nzcIIAAAAAAB30mYXo5QAACrhACj22IAAHfq378.png"
				class="err-product"></a>
			<a rel="nofollow" target="_blank"
				href="https://search.szfw.org/cert/l/CX20120111001803001836"><img
				width="112" height="40"
				src="<c:url value='/resources'/>/images/112_40_WvArIl.png"
				class="err-product"></a>
		</div>
    </div>
</div>
